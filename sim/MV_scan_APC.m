...
for iii = 1:10                                  % Number of trajectories that will be ran (set to 25)
...
filename = ['OVA' num2str(jjj) '_E1_' num2str(1-jjj) '_KSOFF' num2str(sweepvar) '.mat'];
save(filename);
